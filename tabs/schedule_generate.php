...
<!-- Conflict confirmation modal (shown when backend reports needs_confirmation) -->
...
<!-- External JS: handles the existing generation logic and the confirmation modal interaction.
     Place file at tabs/js/schedule_generate_conflicts.js and it will be loaded here. -->
